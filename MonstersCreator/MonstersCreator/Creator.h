...
std::string file_name = "creature.txt";

namespace MonstersCreator {
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->TBoxFilename = (gcnew System::Windows::Forms::TextBox());
			...
			// GrBoxSave
			// 
			this->GrBoxSave->Controls->Add(this->TBoxFilename);
			...
			// TBoxFilename
			// 
			this->TBoxFilename->Location = System::Drawing::Point(9, 74);
			this->TBoxFilename->Name = L"TBoxFilename";
			this->TBoxFilename->Size = System::Drawing::Size(274, 24);
			...
			this->LbFilename->Size = System::Drawing::Size(72, 18);
			this->LbFilename->TabIndex = 0;
			this->LbFilename->Text = L"Filename:";
			// 
			// BtnSaveToFile
			// 
...
#pragma endregion
	...
	private: System::Void BtnNextCon_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		TBoxFilename->Text = Convert::ToString(FILENAME);
	...
	private: System::Void BtnSaveToFile_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		if (TBoxFilename->Text->Length != 0) {
			file_name = msclr::interop::marshal_as<std::string>(TBoxFilename->Text);
		}
		else {
			//file_name = FILENAME;
			//TBoxFilename->Text = Convert::ToString(FILENAME);
